<template>
    ...
    <nav
        v-else
        class="w-full h-16 bg-prussianBlue px-2 min-[390px]:px-8 flex items-center gap-4 text-lightGray"
    >
        <router-link to="/">
            <img
        ...
        <div class="h-full ml-auto flex items-center">
            <div
                class="relative mr-4 hidden sm:flex sm:w-[375px] md:w-[450px] lg:w-[550px]"
            >
                <svg
                    class="absolute top-2 left-3 h-6 w-6"
                    version="1.1"
