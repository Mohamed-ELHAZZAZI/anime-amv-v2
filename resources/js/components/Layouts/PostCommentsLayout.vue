            ...
            <div class="space-y-4" v-if="showReplies">
                <form class="w-full" @submit.prevent="submitReply">
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <button
                            :disabled="submitedModify"
                            :class="submitedModify ? 'cursor-not-allowed' : ''"
                            type="submit"
                        ...
                        >
                            ...
                            <span v-if="!submitedModify">Reply</span>
                            <div
                                v-else
                                role="status"
                                class="flex items-center justify-center w-full h-full"
...
const submitedModify = ref(false);
function submitReply() {
    ...
    replyError.value = "";
    submitedModify.value = true;
    store.dispatch("submitComment", data).then((res) => {
        replyText.value = "";
        submitedModify.value = false;
        if (res.data.error) {
